...
& SOC_0 = \rho \\
& SOC_t = SOC_{t-1} + \eta^{ch} ch_t - \frac{1}{\eta^{dis}} dis_t \quad \forall t=1,\dots,T \\
...
& + \mu_0 (SOC_0 - \rho) \\
& + \sum_{t=1}^T \mu_t (SOC_t - SOC_{t-1} - \eta^{ch} ch_t + \frac{1}{\eta^{dis}} dis_t) \\
...
\begin{itemize}
    ...
    \begin{align}
        ...
        & && SOC_0 = \rho \\
        &\forall t=1,\dots,T: && SOC_t = SOC_{t-1} + \eta^{ch} ch_t - \frac{1}{\eta^{dis}} dis_t \\
    ...
    \begin{align}
        ...
        &\forall t: && \frac{\partial \mathcal{L}}{\partial SOC_t} = 0 \\
        &\forall t: && \frac{\partial \mathcal{L}}{\partial ch_t} = 0 \\
        &\forall t: && \frac{\partial \mathcal{L}}{\partial dis_t} = 0
    \end{align}
